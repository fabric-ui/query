...
export default function Avatar(props) {
   ...
   return (<div className={styles.wrapper} data-size={props.size}
                style={{border: props.outlined ? 'var(--fabric-border-primary) 1px solid' : "unset"}}>
         {props.src ? <img
...
Avatar.propTypes = {
   ...
   size: PropTypes.oneOf(['small', 'medium', 'big']), src: PropTypes.string, alt: PropTypes.string.isRequired
}
